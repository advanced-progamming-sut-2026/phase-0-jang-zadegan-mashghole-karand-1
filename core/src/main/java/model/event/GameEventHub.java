...
public class GameEventHub {
    ...
    public void bindSession(SessionContext context, int difficultyLevel) {
        this.context = context;
        scoreTracker.beginSession(context, difficultyLevel);
    }
    ...
    private void onZombieDied(ZombieDiedEvent e) {
        ...
        scoreTracker.onZombieKilled(context);
        notifyQuests(e);
    }
