...
public enum ZombieType {
        ...
        PARASOL_ZOMBIE("Parasol Zombie",new ZombieBaseStats(350,100,0.25f,200,3000),null,
                        List.of(new ZombieImmunityAbility(ProjectileType.CABBAGE , ProjectileType.MELON))),
        ...
        HUNTER("Hunter Zombie", new ZombieBaseStats(700,100,0.12f,500,3500),null,
                        List.of(new ZombieThrowAbility(0 , 10 , 3, ProjectileType.ICE))),
        ...
        OCTOPUS_ZOMBIE("Octopus Zombie", new ZombieBaseStats(910,100,0.12f,900,3500),null,
                        List.of(new ZombieThrowAbility(0,8,5 ,ProjectileType.OCTOPUS))),
        ...
        IMP_DRAGON("Imp Dragon",new ZombieBaseStats(190,100,0.185f,150,3500),null,List.of(new ZombieImmunityAbility(ProjectileType.FIRE)));
